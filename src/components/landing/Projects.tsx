...
export default function Projects() {
  ...
  return (
    <Container className="mt-2 flex w-full flex-col items-start">
      <SectionHeading subHeading="Selected" heading="Projects" />

      <div className="mt-8 mb-5 flex flex-wrap gap-2 rounded-full border border-[#E5E5E5] bg-[#F9F9F9] p-1 dark:border-[#2a2a2a] dark:bg-[#111]">
