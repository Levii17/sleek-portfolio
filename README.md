...
![Portfolio Preview v1](/public/meta/hero.png)

## Acknowledgments & Credits

- **Base Repository:** Forked from [@ramxcodes](https://github.com/ramxcodes)
- **Design Inspiration:** Shoutout to [@Atharvsinh-codez](https://github.com/Atharvsinh-codez) for the incredible design inspiration!
